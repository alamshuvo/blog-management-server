...
- https://blog-server-vert.vercel.app/

## vedio details

- https://drive.google.com/file/d/14caxDKzj3-pTgn-mrj9sdDZFs6no-zJl/view?usp=sharing
...
1. place an order -EndPoint : GET /api/blogs
   -/api/blogs?search=technology&sortBy=createdAt&sortOrder=desc&-filter=60b8f42f9c2a3c9b7cbd4f18
2. Response : Sucess Message with order details
